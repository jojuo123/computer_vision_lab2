...
public:
	...
	Mat harrisDectect(int blockSize, double sigma, double k, double thresh, int apertureSize);
	...
	Mat lbp(vector<KeyPoint>& kp, int blockSize=3, double sigma=1.0, int thresh=0, double k=0.04, int apertureSize=3, int gridx=16, int gridy=16);
